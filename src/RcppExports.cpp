...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< double >::type sigmaI(sigmaISEXP);
    rcpp_result_gen = Rcpp::wrap(LSRA_MCMC_sim(nits, pars, JumpCV, adapt, parLB, parUB, R0ind, inflind, slpind, RDind, nyears, maxage, M, Mat_age, Wt_age, Chist_a, Ind, Umax, h, CAA, CAAadj, sigmaR, sigmaI));
    return rcpp_result_gen;
END_RCPP
}
// bhnoneq_LL
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_DLMtool_LSRA_MCMC_sim", (DL_FUNC) &_DLMtool_LSRA_MCMC_sim, 23},
