...
matplot(years, t(Depletion),
        type="l", lty=1, bty="l", main="", 
         lwd=plotPars$lwd, ylab="Depletion (spawning biomass)", xlab="Historical Years", las=1, xpd=NA,
        ylim=ylim)
...
matplot(years, t(SSB),
        type="l", lty=1, bty="l", main="", 
         lwd=plotPars$lwd, ylab="SSB", xlab="Historical Years", las=1, xpd=NA,
        ylim=ylim)
```
...
matplot(years, t(Depletion),
        type="l", lty=1, bty="l", main="", 
         lwd=plotPars$lwd, ylab="Depletion (vulnerable biomass)", xlab="Historical Years", las=1, xpd=NA,
        ylim=ylim)
abline(h=1, lty=2, lwd=2, col="darkgray")
```
...
matplot(years, t(Vb),
        type="l", lty=1, bty="l", main="", 
         lwd=plotPars$lwd, ylab="Vuln. Biomass", xlab="Historical Years", las=1, xpd=NA,
        ylim=ylim)
```
...
matplot(years, t(Depletion),
        type="l", lty=1, bty="l", main="", 
         lwd=plotPars$lwd, ylab="Depletion (total biomass)", xlab="Historical Years", las=1, xpd=NA,
        ylim=ylim)
abline(h=1, lty=2, lwd=2, col="darkgray")
```
...
matplot(years, t(B),
        type="l", lty=1, bty="l", main="", 
         lwd=plotPars$lwd, ylab="Total Biomass", xlab="Historical Years", las=1, xpd=NA,
        ylim=ylim)
...
matplot(years, t(Depletion),
        type="l", lty=1, bty="l", main="", 
         lwd=plotPars$lwd, ylab="Recruitment (relative to R0)", xlab="Historical Years", las=1, xpd=NA,
        ylim=ylim)
abline(h=1, lty=2, lwd=2, col="darkgray")
```
...
matplot(years, t(Rec),
        type="l", lty=1, bty="l", main="", 
         lwd=plotPars$lwd, ylab="Recruitment", xlab="Historical Years", las=1, xpd=NA,
        ylim=ylim)
...
matplot(years, t(Depletion),
        type="l", lty=1, bty="l", main="", 
         lwd=plotPars$lwd, ylab="Catch (relative to current year)", xlab="Historical Years", las=1, xpd=NA,
        ylim=ylim)
abline(h=1, lty=2, lwd=2, col="darkgray")
```
...
matplot(years, t(Catch),
        type="l", lty=1, bty="l", main="", 
         lwd=plotPars$lwd, ylab="Catch", xlab="Historical Years", las=1, xpd=NA,
        ylim=ylim)
...
matplot(years, t(Find),
        type="l", lty=1, bty="l", main="", 
         lwd=plotPars$lwd, ylab="Fishing mortality rate (apical)", xlab="Historical Years", las=1, xpd=NA,
        ylim=ylim)
abline(h=1, lty=2, lwd=2, col="darkgray")
```
