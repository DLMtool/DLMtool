...
```{r, echo=FALSE}
par(mfrow=c(1,2))
hist2(Pars$TACSD, main="TACSD", col=plotPars$col, axes=plotPars$axes,
      breaks=plotPars$breaks, cex.main=plotPars$cex.main)
abline(v=Pars$TACSD[its], col=1:nsamp, lwd=plotPars$lwd)
axis(side=1) 

hist2(Pars$TACFrac, main="TACFrac", col=plotPars$col, axes=plotPars$axes,
      breaks=plotPars$breaks, cex.main=plotPars$cex.main)
abline(v=Pars$TACFrac[its], col=1:nsamp, lwd=plotPars$lwd)
axis(side=1) 
...
ylim <- c(0, max(ImpList$TACbias[its, ] * ImpList$TACsd[its, ]))
matplot(years, t(ImpList$TACbias[its, ] * ImpList$TACsd[its, ]),
...
```{r, echo=FALSE}
par(mfrow=c(1,2))
hist2(Pars$TAESD, main="TAESD", col=plotPars$col, axes=plotPars$axes,
      breaks=plotPars$breaks, cex.main=plotPars$cex.main)
abline(v=Pars$TAESD[its], col=1:nsamp, lwd=plotPars$lwd)
axis(side=1) 

hist2(Pars$TAEFrac, main="TAEFrac", col=plotPars$col, axes=plotPars$axes,
      breaks=plotPars$breaks, cex.main=plotPars$cex.main)
abline(v=Pars$TAEFrac[its], col=1:nsamp, lwd=plotPars$lwd)
axis(side=1) 
...
ylim <- c(0, max(ImpList$TAEbias[its, ] * ImpList$TAEsd[its, ]))
matplot(years, t(ImpList$TAEbias[its, ] * ImpList$TAEsd[its, ]),
...
```{r, echo=FALSE}
par(mfrow=c(1,2))
hist2(Pars$SizeLimSD, main="SizeLimSD", col=plotPars$col, axes=plotPars$axes,
      breaks=plotPars$breaks, cex.main=plotPars$cex.main)
abline(v=Pars$SizeLimSD[its], col=1:nsamp, lwd=plotPars$lwd)
axis(side=1) 

hist2(Pars$SizeLimFrac, main="SizeLimFrac", col=plotPars$col, axes=plotPars$axes,
      breaks=plotPars$breaks, cex.main=plotPars$cex.main)
abline(v=Pars$SizeLimFrac[its], col=1:nsamp, lwd=plotPars$lwd)
axis(side=1) 
...
ylim <- c(0, max(ImpList$SizeLimFrac[its, ] * ImpList$SizeLimSD[its, ]))
matplot(years, t(ImpList$SizeLimFrac[its, ] * ImpList$SizeLimSD[its, ]),
