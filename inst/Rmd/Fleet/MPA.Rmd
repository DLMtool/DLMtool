...
hist2(Pars$Spat_targ, col=plotPars$col, axes=plotPars$axes, main="Spat_targ", breaks=plotPars$breaks)
abline(v=Pars$Spat_targ[its], col=1:nsamp, lwd=plotPars$lwd)
axis(side=1) 
