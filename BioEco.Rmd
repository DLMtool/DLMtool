...
a small change in effort. 

- based on profit from last year? or last X years?
- same response parameter for increase and decrease fleet?
- landing tax MP

excess profit - economic rent
add ITQ?
...
## The `BioEco` object - add to fleet object
check with Chris - what economic data is available from their survey?
